    ...
    .then(snapshot=>{
        snapshot.forEach(doc=>{
            ...
            if(RequestStatus==="Book Sent"){
                message= this.state.DonorName + " has sent you your book " + firebase.auth().currentUser.email + "." 
            }else{
                message=this.state.DonorName + " is interested in sending you your book, but has not gotten to it yet. It should come soon, " + firebase.auth().currentUser.email + "."
            }
